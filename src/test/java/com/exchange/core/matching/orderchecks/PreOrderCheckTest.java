...
public class PreOrderCheckTest {
    ...
    public void validateOrderTest() {
        ...
        PreOrderCheck preCheck = new PreOrderCheckImpl(counter, accountRepository, instrumentRepository, outbound);
        ...
        when(accountRepository.getAccount(order.getAccount())).thenReturn(new Account(order.getAccount()));
