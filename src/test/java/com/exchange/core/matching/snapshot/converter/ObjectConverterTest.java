...
public class ObjectConverterTest {
  ...
  public void instrumentConfigListTest() {
    ...
    Assertions.assertEquals(
        "[{\"symbol\":\"BTC/USDT\",\"base\":\"BTC\",\"quote\":\"USDT\"},{\"symbol\":\"ETH-USDT\",\"base\":\"ETH\",\"quote\":\"USDT\"},{\"symbol\":\"BTC-ETH\",\"base\":\"BTC\",\"quote\":\"ETH\"}]",
        listStr, "InstrumentConfig string mismatch");
    List<InstrumentConfig> recovered = converter.stringToObj(listStr, new TypeReference<>() {
    });
    Assertions.assertNotSame(list, recovered,
        "Original list and recovered should be different objects");
  ...
  public void stringToObjExceptionTest() {
    ...
    AppException exception = Assertions.assertThrows(AppException.class,
        () -> converter.stringToObj(str, new TypeReference<>() {
        }), "Exception should be thrown");
    Assertions.assertEquals("Failed to read: str=hello world", exception.getMessage(),
